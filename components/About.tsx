...
export const About: React.FC = () => {
  ...
  return (
    <section id="sobre" className="py-20 bg-white dark:bg-slate-950 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Sobre o Projeto</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="p-6 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all duration-300 group">
              <div className="mb-4 p-3 bg-white dark:bg-slate-800 rounded-lg inline-block shadow-sm dark:shadow-none group-hover:scale-110 transition-transform">
                {feature.icon}
              </div>
